...
$this->title = 'Nama OPD: ' . $model->nama;
...
<div class="opd-view">
    ...
    <div class="card">
        ...
        <div class="card-body status-warning" style="display: table-cell">
            <div class="card-header">
                <h5 class="card-title text-warning">Daftar Urusan untuk OPD ini:</h5>
            </div>
                ...
                <table class="table table-borderless text-white-50" id="opd-list">
                    ...
                    if (count($model->urusanOpds) > 0) {
                        foreach ($model->urusanOpds as $i => $urusanOpd) {
                            echo "<tr><td class='col-xs-1' style='text-align: center'></td><td class='col-xs-9'>" . Html::encode($urusanOpd->urusan->nama) . "</td></tr>";
                        }
                    }
                    ?>
                </table>
