...
/* @var $searchModel common\models\UrusanSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Daftar Urusan';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="urusan-index">
    ...
    <div class="card">
        <div class="card-header page-title">
            <h3><?= Html::encode($this->title) ?>
                ...
                <?= Html::a('Buat Urusan', ['create'], ['class' => 'btn btn-outline-success btn-round']) ?>
            </span>
            </h3>
        </div>
        <div class="card-body">
