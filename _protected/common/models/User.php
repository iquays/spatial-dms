...
class User extends UserIdentity
{
    ...
    public function rules()
    {
        return [
            ...
            [['username', 'email', 'status'], 'required', 'message' => 'Kolom {attribute} tidak koleh kosong'],
            ['email', 'email'],
            ['opd_id', 'integer'],
            ...
            ['username', 'unique', 'message' => 'Nama penguna ini sudah digunakan.'],
